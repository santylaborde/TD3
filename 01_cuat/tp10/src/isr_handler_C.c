...
__attribute__(( section(".functions"))) void ISR14_handler_PF_C(dword* ERROR_CODE, dword CR2) 
{   
    ...
    {     
        ...
        dword PT= &PAGING_DPT_VMA;                                         
        PT= PT+0x1000+0x1000*DTP_ENTRY;                                      // DIRECCION DE LA NUEVA PAGE TABLE 
        set_PDE(&(PAGING_DPT_VMA), DTP_ENTRY, PT, 0, 0, 0, 0, 0, 1, 1);    // AGREGA LA NUEVA PAGE TABLE AL DIRECTORIO
