...
__attribute__(( section(".task01"))) void task_01_C(void)
{
    ...
    while (1)
    {
        ...
        screen_print(23,1,(screen_buffer_struct*) &VIDEO_VMA,str_average);
        ...
        char measurement[26]="Direccion del promedio: 0x";
        // Pasa de entero a ASCII para imprimir
        ...
        // Limpia el campo "Promedio" anterior
        screen_print(27,5,(screen_buffer_struct*) &VIDEO_VMA,clean);
        // Escribe la direccion apuntada por el "Promedio"
        screen_print(27,5,(screen_buffer_struct*) &VIDEO_VMA,str_measurement);
