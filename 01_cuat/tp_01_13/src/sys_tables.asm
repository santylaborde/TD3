...
GLOBAL CS_SEL                            ; exportamos etiquetas de GDT
GLOBAL DS_SEL
GLOBAL TSS_SEL
GLOBAL CS_SEL_11
GLOBAL DS_SEL_11
...
EXTERN ISR128_handler_SYSCALLS_L
EXTERN ISR128_handler_SYSCALLS_H
...
NULL_SEL    EQU $ - GDT
    dq 0x0
;***********************
CS_SEL   EQU $ - GDT                        ; calcula dinamicamente el tamaño el selector de segmento 
                                            ; code segment (DPL = 00)
    ...
    db 0x00                                 ; Base 31-24
;***********************                    
DS_SEL      EQU $ - GDT                     ; data segment (DPL = 00)
    ...
    db  0x00                                ; Base 31-24
;***********************
CS_SEL_11   EQU $ - GDT                     ; code segment (DPL = 11)
    dw  0xffff                              ; Limit 15-0
    dw  0x0000                              ; Base 15-0
    db  0x00                                ; Base 23-16
    db  11111001b                           ; Atributos (¡¡¡ AHORA DPL=11 !!!)
    db  11001111b                           ; Atributos + Limit 19-16:
    db  0x00                                ; Base 31-24
;***********************
DS_SEL_11   EQU $ - GDT                     ; data segment (DPL = 11)
    dw  0xffff                              ; Limit 15-0
    dw  0x0000                              ; Base 15-0
    db  0x00                                ; Base 23-16
    db  11110010b                           ; Atributos (¡¡¡ AHORA DPL=11 !!!)
    db  11001111b                           ; Atributos + Limit 19-16:
    db  0x00                                ; Base 31-24
;***********************
TSS_SEL  EQU $ - GDT                        ; task state segment (DPL = 00)
    dw  01100111b                           ; Limit 15-0
                                            ; Base= 0x01250000
    dw  0x0000                              ; Base 15-0  = 0000 0000 0000 0000 = 0x00 
    db  0x25                                ; Base 23-16 = 0010 0101 = 0x25
                                            ; Base 31-24 = 0000 0001 = 0x1  
    db  10001001b                           ; Atributos: 
                                            ; P = 1
                                            ; DPL = 00
                                            ; S = 0 con 1 no es de sistema
                                            ; D/C = 1 = Bit 11 (segmento de codigo) si es 0 es de (dato o pila)
                                            ; ED/C = 0 crece para direcciones mayores con 0 y con 1 es expand down
                                            ; R/W = 0
                                            ; A = 1 
    db  00000000b                           ; Limit 19-16 + atributos:
                                            ; G = 0
                                            ; D/B = 0
                                            ; L = 0
                                            ; AVL = 0
...
gdtr:
    ...
    dd  0x0                                 ; 4bytes para la base (se ubica en el shadow no en la ROM)

; ******************************* IDT ***********************************************
;            _______________________________________________________
;            | VECTOR RANGE |    USE                                 |
;            ---------------------------------------------------------
;            |    00 -  19  | Nonmaskable interrupts and exceptions  |
;            |    20 -  31  | Intel-reserved                         |
;            |    32 - 127  | External interrupts                    |
;            |      128     | Programmed exception for system calls  |
;            |   129 - 238  | External interrupts                    |
...
IRQ0_DE:                                    ; calcula dinamicamente el tama;o el selector de segmento
    ...
    dw CS_SEL                               ; Segment Selector 15-0
    db 0x00                                 ; Reservado(5 bits) + 000
    db 10001111b                            ; Atributos
                                            ; P = 1
                                            ; DPL = 00
                                            ; 0
                                            ; D= 1 Gate 32bits
...
IRQ32_PIT:                                  ; Programmable interval timer (PIT 8254)
    ...
    dw CS_SEL
    db 0x00
    db 10001110b                            ; Gate: 110 (Intterupt Gate)
...
;***********************
IRQ34_127:                                  ; Disponibles para el usuario
    times 94 dq 0x0
;***********************
IRQ128_SYSCALL:                             ; System Calls (INT 0x80)
    dw ISR128_handler_SYSCALLS_L            ; IRQ128
    dw CS_SEL
    db 0x00
    db 11101110b                            ; Atributos
                                            ; P = 1
                                            ; DPL = 11
                                            ; 0
                                            ; D= 1 Gate 32bits
                                            ; Gate: 110 (Intterupt Gate)
    dw ISR128_handler_SYSCALLS_H
