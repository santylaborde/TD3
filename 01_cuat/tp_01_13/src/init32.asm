...
EXTERN  TASK01_BSS_LMA
EXTERN  TASK01_DATA_LMA
EXTERN  TASK01_RODATA_LMA
EXTERN  TASK02_TEXT_LMA
EXTERN  TASK02_BSS_LMA
EXTERN  TASK02_DATA_LMA
EXTERN  TASK02_RODATA_LMA
EXTERN  TASK03_TEXT_LMA
EXTERN  TASK03_BSS_LMA
EXTERN  TASK03_DATA_LMA
EXTERN  TASK03_RODATA_LMA
EXTERN  TASK04_TEXT_LMA
EXTERN  TASK04_BSS_LMA
EXTERN  TASK04_DATA_LMA
EXTERN  TASK04_RODATA_LMA
...
EXTERN  TASK01_BSS_SIZE
EXTERN  TASK01_DATA_SIZE
EXTERN  TASK01_RODATA_SIZE
EXTERN  TASK02_TEXT_SIZE
EXTERN  TASK02_BSS_SIZE
EXTERN  TASK02_DATA_SIZE
EXTERN  TASK02_RODATA_SIZE
EXTERN  TASK03_TEXT_SIZE
EXTERN  TASK03_BSS_SIZE
EXTERN  TASK03_DATA_SIZE
EXTERN  TASK03_RODATA_SIZE
EXTERN  TASK04_TEXT_SIZE
EXTERN  TASK04_BSS_SIZE
EXTERN  TASK04_DATA_SIZE
EXTERN  TASK04_RODATA_SIZE

EXTERN  KERNEL_32_PHY                       ; importo etiquetas PHYSICAL
...
EXTERN  RESET_PHY
EXTERN  KERNEL_TSS_PHY

EXTERN  STACK16_START_PHY
EXTERN  STACK32_START_PHY
EXTERN  STACK32_T1_START_PHY
EXTERN  STACK32_T2_START_PHY
EXTERN  STACK32_T3_START_PHY
EXTERN  STACK32_T4_START_PHY
EXTERN  STACK32_END_PHY
...
EXTERN  TASK02_MMX_PHY
EXTERN  TASK03_MMX_PHY

EXTERN  STACK32_END_VMA			        ; importo etiquetas LINEAR
...
PAG_P_YES   equ 1       ; PRESENT
PAG_P_NO    equ 0       ; NO PRESENT
PAG_RW_W    equ 1       ; WRITEABLE
PAG_RW_R    equ 0       ; READONLY
PAG_US_US   equ 1       ; USER  
PAG_US_SUP  equ 0       ; SUPERVISOR
PAG_PWT_YES equ 1       ; PAGE LEVEL WRITE THROUGH       
PAG_PWT_NO  equ 0       ; PAGE LEVEL NO WRITE THROUGH 
PAG_PCD_YES equ 1       ; PAGE LEVEL CACHE ENABLE                          
PAG_PCD_NO  equ 0       ; PAGE LEVEL CACHE DISABLE
PAG_A       equ 0       ; ACCESSED
PAG_PS_4K   equ 0       ; PAGE SIZE (4KB)
PAG_D       equ 0       ; DIRTY
PAG_PAT     equ 0       ; PAGE TABLE ATTRIBUTE               
...
; 	MAPEO DE LA PILA 32 BITS
    ...
    mov     esp, STACK32_END_PHY            ; se copia en "esp" el fondo de la pila (expand down)
    xor     eax, eax

;   LIMPIA LA PILA
    mov     ecx, STACK32_SIZE               ; carga el contador con el tamaño de la pila

init_stack:                                 ; INICIALIZA LA PILA
    push    eax                             ; escribe ceros en la pila
    loop    init_stack                      ; se repite "ecx" veces 
    mov     esp, STACK32_END_PHY            ; "sp" (stack pointer) apunta nuevamente al final
...
;   COPIA TASK01 DATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK01_DATA_SIZE
    push    TASK01_DATA_PHY
    push    TASK01_DATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK01 RODATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK01_RODATA_SIZE
    push    TASK01_RODATA_PHY
    push    TASK01_RODATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK02 DATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK02_DATA_SIZE
    push    TASK02_DATA_PHY
    push    TASK02_DATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK02 RODATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK02_RODATA_SIZE
    push    TASK02_RODATA_PHY
    push    TASK02_RODATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK03 DATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK03_DATA_SIZE
    push    TASK03_DATA_PHY
    push    TASK03_DATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK03 RODATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK03_RODATA_SIZE
    push    TASK03_RODATA_PHY
    push    TASK03_RODATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK04 DATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK04_DATA_SIZE
    push    TASK04_DATA_PHY
    push    TASK04_DATA_LMA  
    call    td3_memcopy
    leave
...
;   COPIA TASK04 RODATA EN RAM
    push    ebp
    mov     ebp, esp
    push    TASK04_RODATA_SIZE
    push    TASK04_RODATA_PHY
    push    TASK04_RODATA_LMA  
    call    td3_memcopy
    leave
...
;   ROM: INIT16, INIT32, SYSTABLES, FUNCTIONS_ROM & RESET 
;   (0xFFFXXXXX)
    push ebp
    mov ebp, esp
    push PAG_P_YES          
...
;   PT0:P2 FUNCTIONS (0x00002000)
    ...
    push 0x002                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000)   ; Inicio de la tabla de paginas
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   PT0:P864 DPT_TASK01_VMA (TASK01 DIRECTORY PAGE TABLE) (0x00360000)
    push ebp
    mov ebp, esp
    push PAG_P_YES
    push PAG_RW_W
    ...
    push dword(DPT_KERNEL_VMA+0x1000)    ; PT4: Page table 4 (DPT + 4KB +16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave

;   PT1:P96 DPT_TASK02_VMA (TASK02 DIRECTORY PAGE TABLE) (0x00460000)
    push ebp
    mov ebp, esp
    push PAG_P_YES
    push PAG_RW_W
...
;   PT1:P352 DPT_TASK03_VMA (TASK03 DIRECTORY PAGE TABLE) (0x00560000)
    push ebp
    mov ebp, esp
    push PAG_P_YES
    push PAG_RW_W
...
;   PT1:P608 DPT_TASK04_VMA (TASK04 DIRECTORY PAGE TABLE) (0x00660000)
    push ebp
    mov ebp, esp
    push PAG_P_YES
    push PAG_RW_W
...
;   PT4:P592 KERNEL_TSS (KERNEL STATE SEGMENT) (0x01250000)
    push ebp
    mov ebp, esp
    push PAG_P_YES
    push PAG_RW_W
    ...
    push PAG_PAT
    push PAG_G_YES
    push dword(KERNEL_TSS_PHY)          ; Direccion de mapeo
...
; ;   PT5:P1 TASK02_MMX_VMA (0x01400000)
;     push ebp
;     mov ebp, esp
;     push 1                              ; P: Presence
;     push 0                              ; RW: Read and Write
...
;     push 0                              ; PAT: Page table attribute
;     push 0                              ; G: Global
;     push dword(TASK02_MMX_PHY)          ; Direccion de mapeo
;     push 0x000                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
...
; ;   PT5:P256 TASK03_MMX_VMA (0x01500000)
;     push ebp
;     mov ebp, esp
;     push 1                              ; P: Presence
;     push 0                              ; RW: Read and Write
...
;     push 0                              ; PAT: Page table attribute
;     push 0                              ; G: Global
;     push dword(TASK03_MMX_PHY)          ; Direccion de mapeo
;     push 0x100                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
;     push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x05)   ; PT5: Page table 0 (DPT + 24KB)
;     call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
;     leave 
...
;   PT126:P1012 STACK32 (0x1FFF4000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 1                              ; RW: Read and Write
    ...
    push 0                              ; PAT: Page table attribute
    push 0                              ; G: Global
    push dword(STACK32_T1_START_PHY)    ; Direccion de mapeo
    push 0x3F4                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x7F)   ; PT126: Page table 0 (DPT + 512KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 

;   PT126:P1013 STACK32 (0x1FFF5000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 1                              ; RW: Read and Write
    ...
    push 0                              ; PAT: Page table attribute
    push 0                              ; G: Global
    push dword(STACK32_T2_START_PHY)    ; Direccion de mapeo
    push 0x3F5                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x7F)   ; PT126: Page table 0 (DPT + 512KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 

;   PT126:P1014 STACK32 (0x1FFF6000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 1                              ; RW: Read and Write
    ...
    push 0                              ; PAT: Page table attribute
    push 0                              ; G: Global
    push dword(STACK32_T3_START_PHY)    ; Direccion de mapeo
    push 0x3F6                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x7F)   ; PT126: Page table 0 (DPT + 512KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 

;   PT126:P1015 STACK32 (0x1FFF7000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 1                              ; RW: Read and Write
    ...
    push 0                              ; PAT: Page table attribute
    push 0                              ; G: Global
    push dword(STACK32_T4_START_PHY)    ; Direccion de mapeo
    push 0x3F7                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x7F)   ; PT126: Page table 0 (DPT + 512KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   PT126:P1016 STACK32 (0x1FFF8000)
    ...
    push PAG_PAT
    push PAG_G_YES
    push dword(STACK32_START_PHY)      ; Direccion de mapeo
    push 0x3F8                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_KERNEL_VMA+0x1000+0x1000*0x7F)   ; PT126: Page table 0 (DPT + 512KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 

;   PT1023:P1015 ROM:SYS_TABLES (0xFFFF7000) 
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 0                              ; RW: Read and Write
...
;   PT1023:P1018 ROM:INIT_32 (0xFFFFA000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 0                              ; RW: Read and Write
...
;   PT1023:P1019 ROM:INIT_32 (0xFFFFB000)
    push ebp
    mov ebp, esp
    push 1                              ; P: Presence
    push 0                              ; RW: Read and Write
...
;   PT0:P864 DPT_TASK01_VMA (TASK01 DIRECTORY PAGE TABLE) (0x00360000)
    ...
    push dword(DPT_TASK01_PHY)          ; Direccion de mapeo
    push 0x360                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK01_VMA+0x1000)    ; PT4: Page table 4 (DPT + 4KB +16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave
...
;   PT1:P96 DPT_TASK02_VMA (TASK02 DIRECTORY PAGE TABLE) (0x00460000)
    ...
    push dword(DPT_TASK02_PHY)          ; Direccion de mapeo
    push 0x060                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK02_VMA+0x1000+0x1000*0x01)   ; PT1: Page table 1 (DPT + 4KB + 4KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave
...
;   PT4:P592 KERNEL_TSS (KERNEL STATE SEGMENT) (0x01250000)
    ...
    push dword(KERNEL_TSS_PHY)          ; Direccion de mapeo
    push 0x250                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK02_VMA+0x1000+0x1000*0x04)   ; PT4: Page table 4 (DPT + 4KB + 16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   PT1:P352 DPT_TASK03_VMA (TASK03 DIRECTORY PAGE TABLE) (0x00560000)
    ...
    push dword(DPT_TASK03_PHY)          ; Direccion de mapeo
    push 0x160                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK03_VMA+0x1000+0x1000*0x01)   ; PT1: Page table 1 (DPT + 4KB + 4KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave
...
;   PT4:P592 KERNEL_TSS (KERNEL STATE SEGMENT) (0x01250000)
    ...
    push dword(KERNEL_TSS_PHY)          ; Direccion de mapeo
    push 0x250                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK03_VMA+0x1000+0x1000*0x04)   ; PT4: Page table 4 (DPT + 4KB + 16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   PT3:P640 VIDEO (VMA=0x00E80000 <--> PHY=0x000B8000)
    ...
    push dword(VIDEO_PHY)               ; Direccion de mapeo
    push 0x280                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK04_VMA+0x1000+0x1000*0x03)   ; PT3: Page table 0 (DPT + 16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   PT4:P592 KERNEL_TSS (KERNEL STATE SEGMENT) (0x01250000)
    ...
    push dword(KERNEL_TSS_PHY)          ; Direccion de mapeo
    push 0x250                          ; Entry: Offset de la tabla de paginas  (10 bits mas significativos de la VMA)
    push dword(DPT_TASK04_VMA+0x1000+0x1000*0x04)   ; PT4: Page table 4 (DPT + 4KB + 16KB)
    call set_PTE                        ; Llama a Page Table Entry para crear un Descriptor en la PT.
    leave 
...
;   SALTAMOS A FUNCION PRINCIPAL
    xchg bx,bx    
    jmp CS_SEL:KERNEL_32_INIT        ; El salto a la direccion VMA Lineal 0x01220000           
