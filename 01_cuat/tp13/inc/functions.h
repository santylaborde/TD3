...
extern qword ADDED_TASK02;
extern qword ADDED_TASK03;
...
// Prototypes: Syscalls
__attribute__((section(".functions"))) void td3_halt(void);
__attribute__((section(".functions"))) unsigned int td3_read(void *buffer, unsigned int offset);
__attribute__((section(".functions"))) void td3_print(byte X, byte Y, char* msg);
__attribute__((section(".functions"))) void td3_write(void *buffer, unsigned int offset, qword msg);